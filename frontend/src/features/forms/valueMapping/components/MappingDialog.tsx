...
import { checkValueTypeCompatibility, type MappingConfirmation } from "../store";
import { useValueLinks } from "@/features/forms/hooks/useValueLinks";
import { buildMappingKey } from "@/features/forms/utils/path";
