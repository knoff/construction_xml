...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
                ...
                <div align="center" style="width: 800px; position: absolute; left: 50%; margin-left: -400px;">
                    ...
                    <div class="frame">
                        ...
                        <xsl:if test="ExplanatoryNoteModifications">
                            <div>
                                ...
                                <table style="width: 300px; align: left; padding: 20px;" align="left">
                                    <tr>
                                        <td colspan="2" class="title">Внесенные изменения</td>
                                    </tr>
                                    <tr>
                        ...
                        <table>
                            <tr>
                                <td class="noborder">
                                    <p class="left">Главный инженер проекта</p>
                                </td>
                                <td class="noborder">
                                    <p class="right">
                                        <xsl:value-of select="Signers/ChiefProjectEngineer/FamilyName"/>
                                        <xsl:text> </xsl:text>
                                        <xsl:value-of select="Signers/ChiefProjectEngineer/FirstName"/>
                                        <xsl:text> </xsl:text>
                                        <xsl:value-of select="Signers/ChiefProjectEngineer/SecondName"/>
                                    </p>
                                </td>
                            </tr>

                            <xsl:if test="Signers/ChiefProjectArchitect">
                                <tr>
                                    <td class="noborder">
                                        <p class="left">Главный архитектор проекта</p>
                                    </td>
                                    <td class="noborder">
                                        <p class="right">
                                            <xsl:value-of select="Signers/ChiefProjectArchitect/FamilyName"/>
                                            <xsl:text> </xsl:text>
                                            <xsl:value-of select="Signers/ChiefProjectArchitect/FirstName"/>
                                            <xsl:text> </xsl:text>
                                            <xsl:value-of select="Signers/ChiefProjectArchitect/SecondName"/>
                                        </p>
                                    </td>
                                </tr>
                            </xsl:if>
                    ...
                    <table>
                        ...
                        <xsl:if test="UsedNorms">
                            <tr>
                                <td class="content">
                                    <a href="#UsedNorms">Перечень документов, в результате применения которых обеспечивается соблюдение требований технических регламентов и иных требований, указанных в пункте 1 части 5 статьи 49 Градостроительного кодекса Российской Федерации, используемых при подготовке проектной документации</a>
                                </td>
                            </tr>
                        </xsl:if>
                        ...
                        <xsl:if test="$Object/PowerIndicator">
                            <tr>
                                <td class="content">
                                    <a href="#PowerIndicator">Сведения о проектной мощности объекта капитального строительства</a>
                                </td>
                            </tr>
                        </xsl:if>
                        ...
                        <xsl:if test="$Object/ResponsibilityLevel">
                            <tr>
                                <td class="content">
                                    <a href="#ResponsibilityLevel">Сведения об уровне ответственности</a>
                                </td>
                            </tr>
                        </xsl:if>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="LinearObject">
                            <xsl:if test="$Object/ProjectDocumentation">
                                <xsl:call-template name="LinearProjectDocumentContent">
                                    <xsl:with-param name="DocumentationContent" select="$Object/ProjectDocumentation"/>
                                </xsl:call-template>
                            </xsl:if>
                            <xsl:if test="$Object/GasProjectDocumentation">
                                <xsl:call-template name="GasLinearProjectDocumentContent">
                                    <xsl:with-param name="DocumentationContent" select="$Object/GasProjectDocumentation"/>
                                </xsl:call-template>
                            </xsl:if>
                        </xsl:when>
                    </xsl:choose>
                            ...
                            <xsl:for-each select="//Model">
                                ...
                                <xsl:for-each select="ModelFile">
                                    <tr>
                                        ...
                                        <td>
                                            <xsl:if test="@description">Описание: <xsl:value-of select="@description"/><br/></xsl:if> Имя файла: <xsl:value-of select="FileName"/><br/> Тип модели: <xsl:value-of select="FileFormat"/><br/> Контрольная сумма: <xsl:value-of select="FileChecksum"/>
                    ...
                    <xsl:if test="UsedNorms">
                        <a name="UsedNorms"/>
                        <p class="title">Перечень документов, в результате применения которых обеспечивается соблюдение требований технических регламентов и иных требований, указанных в пункте 1 части 5 статьи 49 Градостроительного кодекса Российской Федерации, используемых при подготовке проектной документации</p>
                    ...
                    <table>
                        ...
                        <xsl:if test="ProjectInitialDocuments/Document[DocType &gt; '05.00' and DocType &lt; '06.00' and DocType != '05.03']">
                            <tr>
                                <td colspan="4" class="title">Задания и программы инженерных изысканий</td>
                            </tr>
                            <xsl:for-each select="ProjectInitialDocuments/Document[DocType &gt; '05.00' and DocType &lt; '06.00' and DocType != '05.03']">
                                <xsl:sort select="DocType"/>
                                <xsl:call-template name="MakeDocFileTable"/>
                            </xsl:for-each>
                        </xsl:if>
                        ...
                        <xsl:if test="ProjectInitialDocuments/Document[DocType &gt; '04.00' and DocType &lt; '05.00']">
                            <tr>
                                <td colspan="4" class="title">Технические условия предусмотренные статьей 52.1 Градостроительного кодекса Российской Федерации и иными нормативными правовыми актами, документы о согласовании отступлений от положений технических условий</td>
                            </tr>
                        ...
                        <xsl:if test="ProjectInitialDocuments/Document[DocType &gt; '19.00' and DocType &lt; '20.00']">
                            <tr>
                                <td colspan="4" class="title">Специальные технические условия предусмотренные статьей 52.1 Градостроительного кодекса Российской Федерации и иными нормативными правовыми актами, документы о согласовании отступлений от положений специальных технических условий</td>
                            </tr>
                        ...
                        <xsl:if test="ProjectInitialDocuments/Document[DocType &gt; '11.01' and DocType &lt; '13.00']">
                            <tr>
                                <td colspan="4" class="title">Данные для проведения проверки достоверности определения сметной стоимости</td>
                            </tr>
                            <xsl:for-each select="ProjectInitialDocuments/Document[DocType &gt; '11.00' and DocType &lt; '12.00']">
                                <xsl:sort select="DocType"/>
                                <xsl:call-template name="MakeDocFileTable"/>
                            </xsl:for-each>
                        </xsl:if>
                        ...
                        <xsl:if test="ProjectInitialDocuments/Document[DocType &gt; '26.00' and DocType &lt; '27.00']">
                            <tr>
                                <td colspan="4" class="title">Обоснование соответствия проектных значений параметров и других проектных характеристик здания или сооружения требованиям безопасности.</td>
                            </tr>
                            <xsl:for-each select="ProjectInitialDocuments/Document[DocType &gt; '26.00' and DocType &lt; '27.00']">
                                <xsl:sort select="DocType"/>
                                <xsl:call-template name="MakeDocFileTable"/>
                            </xsl:for-each>
                        </xsl:if>

                        <xsl:if test="ProjectInitialDocuments/Document[DocType &gt; '99.00']">
                            <tr>
                                <td colspan="4" class="title">Иные исходно-разрешительные документы</td>
                            </tr>
                            <xsl:for-each select="ProjectInitialDocuments/Document[DocType &gt; '99.00']">
                                <xsl:sort select="DocType"/>
                                <xsl:call-template name="MakeDocFileTable"/>
                            </xsl:for-each>
                        </xsl:if>
                    ...
                    <a name="Object"/>
                    <xsl:if test="IndustrialObject or NonIndustrialObject">
                        <p class="title">Сведения об объекте капитального строительства, его функциональном назначении, составе и характеристике производства, номенклатуре выпускаемой продукции (работ, услуг)</p>
                        <br/>
                        <p>
                    ...
                    <p>Объект расположен на <xsl:if test="$Object/@Placement = 1"> суше.</xsl:if>
                    ...
                    <xsl:if test="$Object/ConstructionDuration or $Object/ConstructionDates/*">
                        <p class="title">Сведения о сроках проведении работ: </p>
                        <xsl:if test="$Object/ConstructionDuration">
                    ...
                    <xsl:if test="$Object/PowerIndicator">
                        ...
                        <p class="title">Сведения о проектной мощности объекта капитального строительства</p>
                        <table style="border-style: solid; border-width:1px; border-collapse: collapse; align: center;">
                            <tr>
                    ...
                    <xsl:if test="$Object/ResponsibilityLevel">
                        ...
                        <p>Уровень ответственности: <xsl:value-of select="$Object/ResponsibilityLevel"/></p>
                        <br/>
                    </xsl:if>
                    ...
                    <xsl:if test="$Object/RawResources">
                        ...
                        <xsl:if test="$Object/RawResources/Resource">
                            <table>
                                <tr>
                                    <td style="width: 10%;" class="title">№ п/п</td>
                    ...
                    <xsl:if test="$Object/LandCategory">
                        ...
                        <xsl:for-each select="$Object/LandCategory">
                            <p>
                    ...
                    <xsl:if test="$Object/StagesInfo">
                        ...
                        <xsl:if test="$Object/StagesInfo/Stage">
                            <xsl:for-each select="$Object/StagesInfo/Stage">
                                ...
                                <p class="no-first-line">Продолжительность работ (месяц): <xsl:value-of select="ConstructionDuration"/></p>
                    ...
                    <xsl:if test="$Object/EnergyEfficiencyLinks">
                        ...
                        <xsl:for-each select="$Object/EnergyEfficiencyLinks/ProjectDocumentationLink">
                            ...
                            <p>
                                <xsl:number value="position()" format="1. "/>
                                <xsl:text> </xsl:text>
                                <xsl:value-of select="DocSectionLink"/>
                                <xsl:text>,</xsl:text>
                                <xsl:value-of select="$space"/>
                                <xsl:value-of select="$Object/ProjectDocumentation//Document[DocNumber = $Num]/DocNumber"/>
                                <xsl:value-of select="$space"/>
                                <xsl:value-of select="$Object/ProjectDocumentation//Document[DocNumber = $Num]/DocName"/>
                            </p>
                        </xsl:for-each>
                        <br/>
                        <br/>
                    ...
                    <xsl:if test="$Object/NuclearPlantFeatures">
                        ...
                        <p class="title">Сведения о компьютерных программах, которые использовались для анализов безопасности атомной станции, об аттестации и верификации применяемых компьютерных программ, о системах сертификации, стандартизации и метрологическом обеспечении, о разработке программы обеспечения качества, отчета по обоснованию безопасности и вероятностных анализов безопасности атомной станции первого и второго уровней, о стационарной системе непрерывного мониторинга технического состояния объекта капитального строительства</p>
                    ...
                    <xsl:if test="DesignerAssurance">
                        ...
                        <xsl:apply-templates select="DesignerAssurance"/>
                        <table>
                            <tr>
                                <td class="noborder">
                                    <p class="left">Главный инженер проекта</p>
                                ...
                                <td class="noborder">
                                    <p class="right">
                                        ...
                                        <xsl:if test="Signers/ChiefProjectEngineer/NOPRIZ">
                                            <span class="smaller">Идентификационный номер<br/>в Национальном реестре специалистов<br/>НОПРИЗ - <xsl:value-of select="Signers/ChiefProjectEngineer/NOPRIZ"/></span>
                                        </xsl:if>
                                    </p>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="noborder">
                                        <p class="right">
                                            ...
                                            <br/>
                                            <xsl:if test="Signers/ChiefProjectArchitect/NOPRIZ">
                                                <span class="smaller">Идентификационный номер<br/>в Национальном реестре специалистов<br/>НОПРИЗ - <xsl:value-of select="Signers/ChiefProjectArchitect/NOPRIZ"/></span>
                                            </xsl:if>
                                        </p>
                                    </td>
                                </tr>
    ...
    <xsl:template name="NonLinearProjectDocumentContent">
        ...
        <xsl:if test="$DocumentationContent/*">
            <table>
                ...
                <tr>
                    <td colspan="4" class="title">Раздел 1. «Пояснительная записка»</td>
                </tr>
                <tr>
                    <td>
                        <xsl:value-of select="ExplanatoryNoteNumber"/>
                ...
                <xsl:for-each select="$DocumentationContent/*">
                    ...
                    <xsl:choose>
                        <xsl:when test="NotDeveloped">
                            <tr>
                                <td colspan="4">Раздел не разрабатывался.</td>
                            </tr>
                        </xsl:when>
                        ...
                        <xsl:when test="name() = 'Section13'">
                            <xsl:for-each select="./SectionContent/*">
                                ...
                                <xsl:for-each select="./Document|./OtherDocument">
                                    <xsl:call-template name="ProjectDocumentTableLine">
                                        <xsl:with-param name="Document" select="."/>
                                    </xsl:call-template>
                                </xsl:for-each>
                        ...
                        <xsl:otherwise>
                            <xsl:for-each select="./SectionContent/Document">
                                <xsl:call-template name="ProjectDocumentTableLine">
                                    <xsl:with-param name="Document" select="."/>
                                </xsl:call-template>
                            </xsl:for-each>
                            <xsl:for-each select="./SectionContent/SubSection">
                                <xsl:call-template name="MakeSubSection">
                                    <xsl:with-param name="SubSection" select="."/>
                                </xsl:call-template>
                            </xsl:for-each>
    ...
    <xsl:template name="NonLinearProjectDocumentsSectionName">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$SectionNumber = 'ObjectEstimates'">Объектные расчеты</xsl:when>
            <xsl:when test="$SectionNumber = 'LocalEstimates'">Локальные расчеты</xsl:when>
            ...
            <xsl:when test="$SectionNumber = 'CivilDefense'">Перечень мероприятий по гражданской обороне, мероприятий по предупреждению чрезвычайных ситуаций природного и техногенного характера</xsl:when>
            <xsl:when test="$SectionNumber = 'CounteringTerrorism'">Мероприятия по противодействию терроризму для объектов использования атомной энергии (в том числе ядерных установок, пунктов хранения ядерных материалов и радиоактивных веществ), опасных производственных объектов, определяемых таковыми в соответствии с законодательством Российской Федерации, особо опасных, технически сложных, уникальных объектов, объектов обороны и безопасности</xsl:when>
            <xsl:when test="$SectionNumber = 'RadiationNuclearSafety'">Мероприятия по радиационной и ядерной безопасности</xsl:when>
            <xsl:when test="$SectionNumber = 'SanitarySafety'">Санитарно-эпидемиологическая безопасность</xsl:when>
            <xsl:when test="$SectionNumber = 'CulturalHeritageSites'">Охрана объектов культурного наследия</xsl:when>
            <xsl:when test="$SectionNumber = 'LandsReclamation'">Мероприятия по рекультивации нарушенных земель</xsl:when>
            <xsl:when test="$SectionNumber = 'BiologicalResourcesImpact'">Оценка воздействия на водные биологические ресурсы</xsl:when>
    ...
    <xsl:template name="GasLinearProjectDocumentContent">
        <xsl:param name="DocumentationContent"/>
        <xsl:if test="$DocumentationContent/*">
            <table>
                <tr>
                ...
                <xsl:for-each select="$DocumentationContent/*">
                    <tr>
                        <td colspan="4" class="title">
                            <xsl:call-template name="GasLinearProjectDocumentsSectionName">
                                <xsl:with-param name="SectionNumber" select="name()"/>
                            </xsl:call-template>
                        </td>
                    </tr>
    ...
    <xsl:template name="GasLinearProjectDocumentsSectionName">
        <xsl:param name="SectionNumber"/>
        <xsl:choose>
            <xsl:when test="$SectionNumber = 'Section2'">Раздел 2. «Проект полосы отвода»</xsl:when>
            <xsl:when test="$SectionNumber = 'Section3'">Раздел 3. «Технологические и конструктивные решения линейного объекта. Искусственные сооружения»</xsl:when>
            <xsl:when test="$SectionNumber = 'Section4'">Раздел 4. «Проект организации строительства»</xsl:when>
            <xsl:when test="$SectionNumber = 'Section5'">Раздел 5. «Проект организации работ по сносу (демонтажу) линейного объекта»</xsl:when>
            <xsl:when test="$SectionNumber = 'Section6'">Раздел 6. «Смета на строительство, реконструкцию, капитальный ремонт, снос объекта капитального строительства»</xsl:when>
            <xsl:when test="$SectionNumber = 'Section7'">Раздел 7. «Иная документация в случаях, предусмотренных законодательными и иными нормативными правовыми актами Российской Федерации»</xsl:when>
            <xsl:when test="$SectionNumber = 'EstimateExplanatoryNote'">Пояснительная записка к сметной документации</xsl:when>
            <xsl:when test="$SectionNumber = 'CostSummary'">Сводка затрат</xsl:when>
            <xsl:when test="$SectionNumber = 'SummaryEstimate'">Сводный сметный расчет</xsl:when>
            <xsl:when test="$SectionNumber = 'ObjectEstimates'">Объектные расчеты</xsl:when>
    ...
    <xsl:template name="ProjectDocumentTableLine">
        ...
        <xsl:variable name="FileNumber">
            <xsl:if test="$Document/IULFile">
                <xsl:value-of select="count($Document/IULFile) + count($Document/IULFile/SignFile) + 1 + count($Document/File) + count($Document/File/SignFile)"/>
            </xsl:if>
            <xsl:if test="not($Document/IULFile)">
                <xsl:value-of select="count($Document/File) + count($Document/File/SignFile)"/>
            </xsl:if>
        </xsl:variable>
        <xsl:variable name="IULNumber" select="count($Document/IULFile)"/>
        <xsl:variable name="Pos" select="position()"/>
            ...
            <tr>
                <xsl:if test="position() = 1">
                    <td style="width: 10%;">
                        ...
                        <xsl:value-of select="$Document/DocNumber"/>
                    </td>
                    <td style="width: 50%;">
                        <xsl:attribute name="rowspan">
                            <xsl:value-of select="$FileNumber"/>
                        ...
                        <xsl:if test="$Document/ProjectDocParticipants/ProjectDocParticipant[@role = 'Разработка']">
                            <br/>Разработка:<br/>
                            <xsl:for-each select="$Document/ProjectDocParticipants/ProjectDocParticipant[@role = 'Разработка']">
                                <xsl:value-of select="FamilyName"/>
                                <xsl:text> </xsl:text>
                                <xsl:value-of select="FirstName"/>
                                <xsl:text> </xsl:text>
                                ...
                                <br/>
                                <xsl:if test="NOPRIZ">
                                    <span class="smaller">Идентификационный номер<br/>в Национальном реестре специалистов<br/>НОПРИЗ - <xsl:value-of select="NOPRIZ"/></span>
                                </xsl:if>
                                <br/>
                            </xsl:for-each>
                        </xsl:if>
                        <xsl:if test="$Document/ProjectDocParticipants/ProjectDocParticipant[@role = 'Нормоконтроль']">
                            <br/>Нормоконтроль:<br/>
                            <xsl:for-each select="$Document/ProjectDocParticipants/ProjectDocParticipant[@role = 'Нормоконтроль']">
                                <xsl:value-of select="FamilyName"/>
                                <xsl:text> </xsl:text>
                                <xsl:value-of select="FirstName"/>
                                <xsl:text> </xsl:text>
                        ...
                        <xsl:if test="$Document/ProjectDocParticipants/ProjectDocParticipant[@role = 'Согласование']">
                            <br/>Согласование:<br/>
                            <xsl:for-each select="$Document/ProjectDocParticipants/ProjectDocParticipant[@role = 'Согласование']"> <xsl:value-of select="FamilyName"/>
                                <xsl:text> </xsl:text>
                                <xsl:value-of select="FirstName"/>
                                <xsl:text> </xsl:text>
                                <xsl:value-of select="SecondName"/>
        ...
        <xsl:for-each select="$Document/IULFile">
            <xsl:if test="position() = 1">
                <tr>
                    <td colspan="2">
    ...
    <xsl:template name="PrintFunctions">
        ...
        <xsl:if test="$Functions/FunctionsClass">
            <p>
                <span class="field">Функциональное назначение по классификатору объектов капитального строительства по их назначению и функционально-технологическим особенностям (для целей архитектурно-строительного проектирования и ведения единого государственного реестра заключений экспертизы проектной документации объектов капитального строительства): </span>
    ...
    <xsl:template match="
            UsedAbbreviations | DesignerNote | FunctionsFeatures | DangerousNatureProcesses |
    ...
    <xsl:template match="SROMembership">
        <span class="no-first-line field">Является членом СРО:</span>
        <br/>
        <xsl:for-each select="SRO">
            <span class="no-first-line"><xsl:value-of select="@SROType"/> - <xsl:value-of select="."/></span>
            <br/>
        </xsl:for-each>
    </xsl:template>
    ...
    <xsl:template match="Measure">
        <xsl:choose>
            <xsl:when test=". = '003'">мм</xsl:when>
            <!--Миллиметр-->
            <xsl:when test=". = '004'">см</xsl:when>
            <!--Сантиметр-->
            <xsl:when test=". = '005'">дм</xsl:when>
            <!--Дециметр-->
            <xsl:when test=". = '006'">м</xsl:when>
            <!--Метр-->
            <xsl:when test=". = '008'">км; тыс. м</xsl:when>
            <!--Километр; тысяча метров-->
            <xsl:when test=". = '009'">Мм; млн. м</xsl:when>
            <!--Мегаметр; миллион метров-->
            <xsl:when test=". = '039'">дюйм</xsl:when>
            <!--Дюйм (25,4 мм)-->
            <xsl:when test=". = '041'">фут</xsl:when>
            <!--Фут (0,3048 м)-->
            <xsl:when test=". = '043'">ярд</xsl:when>
            <!--Ярд (0,9144 м)-->
            <xsl:when test=". = '047'">миля</xsl:when>
            <!--Морская миля (1852 м)-->
            <xsl:when test=". = '050'">мм<sup><small>2</small></sup></xsl:when>
            <!--Квадратный миллиметр-->
            <xsl:when test=". = '051'">см<sup><small>2</small></sup></xsl:when>
            <!--Квадратный сантиметр-->
            <xsl:when test=". = '053'">дм<sup><small>2</small></sup></xsl:when>
            <!--Квадратный дециметр-->
            <xsl:when test=". = '055'">м<sup><small>2</small></sup></xsl:when>
            <!--Квадратный метр-->
            <xsl:when test=". = '058'">тыс. м<sup><small>2</small></sup></xsl:when>
            <!--Тысяча квадратных метров-->
            <xsl:when test=". = '059'">га</xsl:when>
            <!--Гектар-->
            <xsl:when test=". = '061'">км<sup><small>2</small></sup></xsl:when>
            <!--Квадратный километр-->
            <xsl:when test=". = '071'">дюйм<sup><small>2</small></sup></xsl:when>
            <!--Квадратный дюйм (645,16 мм<sup><small>2)-->
            <xsl:when test=". = '073'">фут<sup><small>2</small></sup></xsl:when>
            <!--Квадратный фут (0,092903 м<sup><small>2)-->
            <xsl:when test=". = '075'">ярд<sup><small>2</small></sup></xsl:when>
            <!--Квадратный ярд (0,8361274 м<sup><small>2)-->
            <xsl:when test=". = '109'">а</xsl:when>
            <!--Ар (100 м<sup><small>2)-->
            <xsl:when test=". = '110'">мм<sup><small>3</small></sup></xsl:when>
            <!--Кубический миллиметр-->
            <xsl:when test=". = '111'">см<sup><small>3</small></sup>; мл</xsl:when>
            <!--Кубический сантиметр; миллилитр-->
            <xsl:when test=". = '112'">л; дм<sup><small>3</small></sup></xsl:when>
            <!--Литр; кубический дециметр-->
            <xsl:when test=". = '113'">м<sup><small>3</small></sup></xsl:when>
            <!--Кубический метр-->
            <xsl:when test=". = '118'">дл</xsl:when>
            <!--Децилитр-->
            <xsl:when test=". = '122'">гл</xsl:when>
            <!--Гектолитр-->
            <xsl:when test=". = '126'">Мл</xsl:when>
            <!--Мегалитр-->
            <xsl:when test=". = '131'">дюйм<sup><small>3</small></sup></xsl:when>
            <!--Кубический дюйм (16387,1 мм<sup><small>3)-->
            <xsl:when test=". = '132'">фут<sup><small>3</small></sup></xsl:when>
            <!--Кубический фут (0,02831685 м<sup><small>3)-->
            <xsl:when test=". = '133'">ярд<sup><small>3</small></sup></xsl:when>
            <!--Кубический ярд (0,764555 м<sup><small>3)-->
            <xsl:when test=". = '159'">млн. м<sup><small>3</small></sup></xsl:when>
            <!--Миллион кубических метров-->
            <xsl:when test=". = '160'">гг</xsl:when>
            <!--Гектограмм-->
            <xsl:when test=". = '161'">мг</xsl:when>
            <!--Миллиграмм-->
            <xsl:when test=". = '162'">кар</xsl:when>
            <!--Метрический карат-->
            <xsl:when test=". = '163'">г</xsl:when>
            <!--Грамм-->
            <xsl:when test=". = '166'">кг</xsl:when>
            <!--Килограмм-->
            <xsl:when test=". = '168'">т</xsl:when>
            <!--Тонна; метрическая тонна (1000 кг)-->
            <xsl:when test=". = '170'">тыс. т</xsl:when>
            <!--Килотонна-->
            <xsl:when test=". = '173'">сг</xsl:when>
            <!--Сантиграмм-->
            <xsl:when test=". = '181'">БРТ</xsl:when>
            <!--Брутто-регистровая тонна (2,8316 м<sup><small>3)-->
            <xsl:when test=". = '185'">т грп</xsl:when>
            <!--Грузоподъемность в метрических тоннах-->
            <xsl:when test=". = '206'">ц</xsl:when>
            <!--Центнер (метрический) (100 кг); гектокилограмм; квинтал (метрический); децитонна-->
            <xsl:when test=". = '212'">Вт</xsl:when>
            <!--Ватт-->
            <xsl:when test=". = '214'">кВт</xsl:when>
            <!--Киловатт-->
            <xsl:when test=". = '215'">МВт; тыс. кВт</xsl:when>
            <!--Мегаватт; тысяча киловатт-->
            <xsl:when test=". = '222'">В</xsl:when>
            <!--Вольт-->
            <xsl:when test=". = '223'">кВ</xsl:when>
            <!--Киловольт-->
            <xsl:when test=". = '227'">кВ.А</xsl:when>
            <!--Киловольт-ампер-->
            <xsl:when test=". = '228'">МВ.А</xsl:when>
            <!--Мегавольт-ампер (тысяча киловольт-ампер)-->
            <xsl:when test=". = '230'">квар</xsl:when>
            <!--Киловар-->
            <xsl:when test=". = '243'">Вт.ч</xsl:when>
            <!--Ватт-час-->
            <xsl:when test=". = '245'">кВт.ч</xsl:when>
            <!--Киловатт-час-->
            <xsl:when test=". = '246'">МВт.ч; тыс. кВт.ч</xsl:when>
            <!--Мегаватт-час; 1000 киловатт-часов-->
            <xsl:when test=". = '247'">ГВт.ч</xsl:when>
            <!--Гигаватт-час (миллион киловатт-часов)-->
            <xsl:when test=". = '260'">А</xsl:when>
            <!--Ампер-->
            <xsl:when test=". = '263'">А.ч</xsl:when>
            <!--Ампер-час (3,6 кКл)-->
            <xsl:when test=". = '264'">тыс. А.ч</xsl:when>
            <!--Тысяча ампер-часов-->
            <xsl:when test=". = '270'">Кл</xsl:when>
            <!--Кулон-->
            <xsl:when test=". = '271'">Дж</xsl:when>
            <!--Джоуль-->
            <xsl:when test=". = '273'">кДж</xsl:when>
            <!--Килоджоуль-->
            <xsl:when test=". = '274'">Ом</xsl:when>
            <!--Ом-->
            <xsl:when test=". = '280'">°C</xsl:when>
            <!--Градус Цельсия-->
            <xsl:when test=". = '281'">°F</xsl:when>
            <!--Градус Фаренгейта-->
            <xsl:when test=". = '282'">кд</xsl:when>
            <!--Кандела-->
            <xsl:when test=". = '283'">лк</xsl:when>
            <!--Люкс-->
            <xsl:when test=". = '284'">лм</xsl:when>
            <!--Люмен-->
            <xsl:when test=". = '288'">K</xsl:when>
            <!--Кельвин-->
            <xsl:when test=". = '289'">Н</xsl:when>
            <!--Ньютон-->
            <xsl:when test=". = '290'">Гц</xsl:when>
            <!--Герц-->
            <xsl:when test=". = '291'">кГц</xsl:when>
            <!--Килогерц-->
            <xsl:when test=". = '292'">МГц</xsl:when>
            <!--Мегагерц-->
            <xsl:when test=". = '294'">Па</xsl:when>
            <!--Паскаль-->
            <xsl:when test=". = '296'">См</xsl:when>
            <!--Сименс-->
            <xsl:when test=". = '297'">кПа</xsl:when>
            <!--Килопаскаль-->
            <xsl:when test=". = '298'">МПа</xsl:when>
            <!--Мегапаскаль-->
            <xsl:when test=". = '300'">атм</xsl:when>
            <!--Физическая атмосфера (101325 Па)-->
            <xsl:when test=". = '301'">ат</xsl:when>
            <!--Техническая атмосфера (98066,5 Па)-->
            <xsl:when test=". = '302'">ГБк</xsl:when>
            <!--Гигабеккерель-->
            <xsl:when test=". = '304'">мКи</xsl:when>
            <!--Милликюри-->
            <xsl:when test=". = '305'">Ки</xsl:when>
            <!--Кюри-->
            <xsl:when test=". = '306'">г Д/И</xsl:when>
            <!--Грамм делящихся изотопов-->
            <xsl:when test=". = '308'">мб</xsl:when>
            <!--Миллибар-->
            <xsl:when test=". = '309'">бар</xsl:when>
            <!--Бар-->
            <xsl:when test=". = '310'">гб</xsl:when>
            <!--Гектобар-->
            <xsl:when test=". = '312'">кб</xsl:when>
            <!--Килобар-->
            <xsl:when test=". = '314'">Ф</xsl:when>
            <!--Фарад-->
            <xsl:when test=". = '316'">кг/м<sup><small>3</small></sup></xsl:when>
            <!--Килограмм на кубический метр-->
            <xsl:when test=". = '323'">Бк</xsl:when>
            <!--Беккерель-->
            <xsl:when test=". = '324'">Вб</xsl:when>
            <!--Вебер-->
            <xsl:when test=". = '327'">уз</xsl:when>
            <!--Узел (миля/ч)-->
            <xsl:when test=". = '328'">м/с</xsl:when>
            <!--Метр в секунду-->
            <xsl:when test=". = '330'">об/с</xsl:when>
            <!--Оборот в секунду-->
            <xsl:when test=". = '331'">об/мин</xsl:when>
            <!--Оборот в минуту-->
            <xsl:when test=". = '333'">км/ч</xsl:when>
            <!--Километр в час-->
            <xsl:when test=". = '335'">м/с<sup><small>2</small></sup></xsl:when>
            <!--Метр на секунду в квадрате-->
            <xsl:when test=". = '349'">Кл/кг</xsl:when>
            <!--Кулон на килограмм-->
            <xsl:when test=". = '354'">с</xsl:when>
            <!--Секунда-->
            <xsl:when test=". = '355'">мин</xsl:when>
            <!--Минута-->
            <xsl:when test=". = '356'">ч</xsl:when>
            <!--Час-->
            <xsl:when test=". = '359'">сут; дн</xsl:when>
            <!--Сутки-->
            <xsl:when test=". = '360'">нед</xsl:when>
            <!--Неделя-->
            <xsl:when test=". = '361'">дек</xsl:when>
            <!--Декада-->
            <xsl:when test=". = '362'">мес</xsl:when>
            <!--Месяц-->
            <xsl:when test=". = '364'">кварт</xsl:when>
            <!--Квартал-->
            <xsl:when test=". = '365'">полгода</xsl:when>
            <!--Полугодие-->
            <xsl:when test=". = '366'">г; лет</xsl:when>
            <!--Год-->
            <xsl:when test=". = '368'">деслет</xsl:when>
            <!--Десятилетие-->
            <xsl:when test=". = '499'">кг/с</xsl:when>
            <!--Килограмм в секунду-->
            <xsl:when test=". = '533'">т пар/ч</xsl:when>
            <!--Тонна пара в час-->
            <xsl:when test=". = '596'">м<sup><small>3</small></sup>/с</xsl:when>
            <!--Кубический метр в секунду-->
            <xsl:when test=". = '598'">м<sup><small>3</small></sup>/ч</xsl:when>
            <!--Кубический метр в час-->
            <xsl:when test=". = '599'">тыс. м<sup><small>3</small></sup>/сут</xsl:when>
            <!--Тысяча кубических метров в сутки-->
            <xsl:when test=". = '616'">боб</xsl:when>
            <!--Бобина-->
            <xsl:when test=". = '625'">л.</xsl:when>
            <!--Лист-->
            <xsl:when test=". = '626'">100 л.</xsl:when>
            <!--Сто листов-->
            <xsl:when test=". = '630'">тыс станд. усл. кирп</xsl:when>
            <!--Тысяча стандартных условных кирпичей-->
            <xsl:when test=". = '641'">дюжина</xsl:when>
            <!--Дюжина (12 шт.)-->
            <xsl:when test=". = '657'">изд</xsl:when>
            <!--Изделие-->
            <xsl:when test=". = '683'">100 ящ.</xsl:when>
            <!--Сто ящиков-->
            <xsl:when test=". = '704'">набор</xsl:when>
            <!--Набор-->
            <xsl:when test=". = '715'">пар</xsl:when>
            <!--Пара (2 шт.)-->
            <xsl:when test=". = '730'">20</xsl:when>
            <!--Два десятка-->
            <xsl:when test=". = '732'">10 пар</xsl:when>
            <!--Десять пар-->
            <xsl:when test=". = '733'">дюжина пар</xsl:when>
            <!--Дюжина пар-->
            <xsl:when test=". = '734'">посыл</xsl:when>
            <!--Посылка-->
            <xsl:when test=". = '735'">часть</xsl:when>
            <!--Часть-->
            <xsl:when test=". = '736'">рул</xsl:when>
            <!--Рулон-->
            <xsl:when test=". = '737'">дюжина рул</xsl:when>
            <!--Дюжина рулонов-->
            <xsl:when test=". = '740'">дюжина шт</xsl:when>
            <!--Дюжина штук-->
            <xsl:when test=". = '745'">элем</xsl:when>
            <!--Элемент-->
            <xsl:when test=". = '778'">упак</xsl:when>
            <!--Упаковка-->
            <xsl:when test=". = '780'">дюжина упак</xsl:when>
            <!--Дюжина упаковок-->
            <xsl:when test=". = '781'">100 упак</xsl:when>
            <!--Сто упаковок-->
            <xsl:when test=". = '796'">шт</xsl:when>
            <!--Штука-->
            <xsl:when test=". = '797'">100 шт</xsl:when>
            <!--Сто штук-->
            <xsl:when test=". = '798'">тыс. шт; 1000 шт</xsl:when>
            <!--Тысяча штук-->
            <xsl:when test=". = '799'">млн. шт</xsl:when>
            <!--Миллион штук-->
            <xsl:when test=". = '800'">млрд. шт</xsl:when>
            <!--Миллиард штук-->
            <xsl:when test=". = '801'">Биллион шт</xsl:when>
            <!--Биллион штук (Европа); триллион штук-->
            <xsl:when test=". = '802'">Квинтильон шт</xsl:when>
            <!--Квинтильон штук (Европа)-->
            <xsl:when test=". = '820'">креп. спирта по массе</xsl:when>
            <!--Крепость спирта по массе-->
            <xsl:when test=". = '821'">креп. спирта по объему</xsl:when>
            <!--Крепость спирта по объему-->
            <xsl:when test=". = '831'">л 100% спирта</xsl:when>
            <!--Литр чистого (100%) спирта-->
            <xsl:when test=". = '833'">Гл 100% спирта</xsl:when>
            <!--Гектолитр чистого (100%) спирта-->
            <xsl:when test=". = '841'">кг H<sub>2</sub>О<sub>2</sub></xsl:when>
            <!--Килограмм пероксида водорода-->
            <xsl:when test=". = '845'">кг 90% с/в</xsl:when>
            <!--Килограмм 90%-го сухого вещества-->
            <xsl:when test=". = '847'">т 90% с/в</xsl:when>
            <!--Тонна 90%-го сухого вещества-->
            <xsl:when test=". = '852'">кг К<sub>2</sub>О</xsl:when>
            <!--Килограмм оксида калия-->
            <xsl:when test=". = '859'">кг КОН</xsl:when>
            <!--Килограмм гидроксида калия-->
            <xsl:when test=". = '861'">кг N</xsl:when>
            <!--Килограмм азота-->
            <xsl:when test=". = '863'">кг NaOH</xsl:when>
            <!--Килограмм гидроксида натрия-->
            <xsl:when test=". = '865'">кг Р<sub>2</sub>О<sub>5</sub></xsl:when>
            <!--Килограмм пятиокиси фосфора-->
            <xsl:when test=". = '867'">кг U</xsl:when>
            <!--Килограмм урана-->
            <xsl:when test=". = '018'">пог. м</xsl:when>
            <!--Погонный метр-->
            <xsl:when test=". = '019'">тыс. пог. м</xsl:when>
            <!--Тысяча погонных метров-->
            <xsl:when test=". = '020'">усл. м</xsl:when>
            <!--Условный метр-->
            <xsl:when test=". = '048'">тыс. усл. м</xsl:when>
            <!--Тысяча условных метров-->
            <xsl:when test=". = '049'">км усл. труб</xsl:when>
            <!--Километр условных труб-->
            <xsl:when test=". = '054'">тыс. дм<sup><small>2</small></sup></xsl:when>
            <!--Тысяча квадратных дециметров-->
            <xsl:when test=". = '056'">млн. дм<sup><small>2</small></sup></xsl:when>
            <!--Миллион квадратных дециметров-->
            <xsl:when test=". = '057'">млн. м<sup><small>2</small></sup></xsl:when>
            <!--Миллион квадратных метров-->
            <xsl:when test=". = '060'">тыс. га</xsl:when>
            <!--Тысяча гектаров-->
            <xsl:when test=". = '062'">усл. м<sup><small>2</small></sup></xsl:when>
            <!--Условный квадратный метр-->
            <xsl:when test=". = '063'">тыс. усл. м<sup><small>2</small></sup></xsl:when>
            <!--Тысяча условных квадратных метров-->
            <xsl:when test=". = '064'">млн. усл. м<sup><small>2</small></sup></xsl:when>
            <!--Миллион условных квадратных метров-->
            <xsl:when test=". = '081'">м<sup><small>2</small></sup> общ. пл</xsl:when>
            <!--Квадратный метр общей площади-->
            <xsl:when test=". = '082'">тыс. м<sup><small/></sup>2 общ. пл</xsl:when>
            <!--Тысяча квадратных метров общей площади-->
            <xsl:when test=". = '083'">млн. м<sup><small>2</small></sup> общ. пл</xsl:when>
            <!--Миллион квадратных метров общей площади-->
            <xsl:when test=". = '084'">м<sup><small>2</small></sup> жил. пл</xsl:when>
            <!--Квадратный метр жилой площади-->
            <xsl:when test=". = '085'">тыс. м<sup><small>2</small></sup> жил. пл</xsl:when>
            <!--Тысяча квадратных метров жилой площади-->
            <xsl:when test=". = '086'">млн. м<sup><small>2</small></sup> жил. пл</xsl:when>
            <!--Миллион квадратных метров жилой площади-->
            <xsl:when test=". = '087'">м<sup><small>2</small></sup> уч. лаб. здан</xsl:when>
            <!--Квадратный метр учебно-лабораторных зданий-->
            <xsl:when test=". = '088'">тыс. м<sup><small>2</small></sup> уч. лаб. здан</xsl:when>
            <!--Тысяча квадратных метров учебно-лабораторных зданий-->
            <xsl:when test=". = '089'">млн. м<sup><small>2</small></sup> 2 мм исч</xsl:when>
            <!--Миллион квадратных метров в двухмиллиметровом исчислении-->
            <xsl:when test=". = '114'">тыс. м<sup><small>3</small></sup></xsl:when>
            <!--Тысяча кубических метров-->
            <xsl:when test=". = '115'">млрд. м<sup><small>3</small></sup></xsl:when>
            <!--Миллиард кубических метров-->
            <xsl:when test=". = '116'">дкл</xsl:when>
            <!--Декалитр-->
            <xsl:when test=". = '119'">тыс. дкл</xsl:when>
            <!--Тысяча декалитров-->
            <xsl:when test=". = '120'">млн. дкл</xsl:when>
            <!--Миллион декалитров-->
            <xsl:when test=". = '121'">плотн. м<sup><small>3</small></sup></xsl:when>
            <!--Плотный кубический метр-->
            <xsl:when test=". = '123'">усл. м<sup><small>3</small></sup></xsl:when>
            <!--Условный кубический метр-->
            <xsl:when test=". = '124'">тыс. усл. м<sup><small>3</small></sup></xsl:when>
            <!--Тысяча условных кубических метров-->
            <xsl:when test=". = '125'">млн. м<sup><small>3</small></sup> перераб. газа</xsl:when>
            <!--Миллион кубических метров переработки газа-->
            <xsl:when test=". = '127'">тыс. плотн. м<sup><small>3</small></sup></xsl:when>
            <!--Тысяча плотных кубических метров-->
            <xsl:when test=". = '128'">тыс. пол. л</xsl:when>
            <!--Тысяча полулитров-->
            <xsl:when test=". = '129'">млн. пол. л</xsl:when>
            <!--Миллион полулитров-->
            <xsl:when test=". = '130'">тыс. л; 1000 л</xsl:when>
            <!--Тысяча литров; 1000 литров-->
            <xsl:when test=". = '165'">тыс. кар</xsl:when>
            <!--Тысяча каратов метрических-->
            <xsl:when test=". = '167'">млн. кар</xsl:when>
            <!--Миллион каратов метрических-->
            <xsl:when test=". = '169'">тыс. т</xsl:when>
            <!--Тысяча тонн-->
            <xsl:when test=". = '171'">млн. т</xsl:when>
            <!--Миллион тонн-->
            <xsl:when test=". = '172'">т усл. топл</xsl:when>
            <!--Тонна условного топлива-->
            <xsl:when test=". = '175'">тыс. т усл. топл</xsl:when>
            <!--Тысяча тонн условного топлива-->
            <xsl:when test=". = '176'">млн. т усл. топл</xsl:when>
            <!--Миллион тонн условного топлива-->
            <xsl:when test=". = '177'">тыс. т единовр. хран</xsl:when>
            <!--Тысяча тонн единовременного хранения-->
            <xsl:when test=". = '178'">тыс. т перераб</xsl:when>
            <!--Тысяча тонн переработки-->
            <xsl:when test=". = '179'">усл. т</xsl:when>
            <!--Условная тонна-->
            <xsl:when test=". = '207'">тыс. ц</xsl:when>
            <!--Тысяча центнеров-->
            <xsl:when test=". = '226'">В.А</xsl:when>
            <!--Вольт-ампер-->
            <xsl:when test=". = '231'">м/ч</xsl:when>
            <!--Метр в час-->
            <xsl:when test=". = '232'">ккал</xsl:when>
            <!--Килокалория-->
            <xsl:when test=". = '233'">Гкал</xsl:when>
            <!--Гигакалория-->
            <xsl:when test=". = '234'">тыс. Гкал</xsl:when>
            <!--Тысяча гигакалорий-->
            <xsl:when test=". = '235'">млн. Гкал</xsl:when>
            <!--Миллион гигакалорий-->
            <xsl:when test=". = '236'">кал/ч</xsl:when>
            <!--Калория в час-->
            <xsl:when test=". = '237'">ккал/ч</xsl:when>
            <!--Килокалория в час-->
            <xsl:when test=". = '238'">Гкал/ч</xsl:when>
            <!--Гигакалория в час-->
            <xsl:when test=". = '239'">тыс. Гкал/ч</xsl:when>
            <!--Тысяча гигакалорий в час-->
            <xsl:when test=". = '241'">млн. А.ч</xsl:when>
            <!--Миллион ампер-часов-->
            <xsl:when test=". = '242'">млн. кВ.А</xsl:when>
            <!--Миллион киловольт-ампер-->
            <xsl:when test=". = '248'">кВ.А Р</xsl:when>
            <!--Киловольт-ампер реактивный-->
            <xsl:when test=". = '249'">млрд. кВт.ч</xsl:when>
            <!--Миллиард киловатт-часов-->
            <xsl:when test=". = '250'">тыс. кВ.А Р</xsl:when>
            <!--Тысяча киловольт-ампер реактивных-->
            <xsl:when test=". = '251'">л. с</xsl:when>
            <!--Лошадиная сила-->
            <xsl:when test=". = '252'">тыс. л. с</xsl:when>
            <!--Тысяча лошадиных сил-->
            <xsl:when test=". = '253'">млн. л. с</xsl:when>
            <!--Миллион лошадиных сил-->
            <xsl:when test=". = '254'">бит</xsl:when>
            <!--Бит-->
            <xsl:when test=". = '255'">байт</xsl:when>
            <!--Байт-->
            <xsl:when test=". = '256'">кбайт</xsl:when>
            <!--Килобайт-->
            <xsl:when test=". = '257'">Мбайт</xsl:when>
            <!--Мегабайт-->
            <xsl:when test=". = '258'">бод</xsl:when>
            <!--Бод-->
            <xsl:when test=". = '287'">Гн</xsl:when>
            <!--Генри-->
            <xsl:when test=". = '313'">Тл</xsl:when>
            <!--Тесла-->
            <xsl:when test=". = '317'">кг/см<sup><small>2</small></sup></xsl:when>
            <!--Килограмм на квадратный сантиметр-->
            <xsl:when test=". = '337'">мм вод. ст</xsl:when>
            <!--Миллиметр водяного столба-->
            <xsl:when test=". = '338'">мм рт. ст</xsl:when>
            <!--Миллиметр ртутного столба-->
            <xsl:when test=". = '339'">см вод. ст</xsl:when>
            <!--Сантиметр водяного столба-->
            <xsl:when test=". = '352'">мкс</xsl:when>
            <!--Микросекунда-->
            <xsl:when test=". = '353'">млс</xsl:when>
            <!--Миллисекунда-->
            <xsl:when test=". = '383'">руб</xsl:when>
            <!--Рубль-->
            <xsl:when test=". = '384'">тыс. руб</xsl:when>
            <!--Тысяча рублей-->
            <xsl:when test=". = '385'">млн. руб</xsl:when>
            <!--Миллион рублей-->
            <xsl:when test=". = '386'">млрд. руб</xsl:when>
            <!--Миллиард рублей-->
            <xsl:when test=". = '387'">трлн. руб</xsl:when>
            <!--Триллион рублей-->
            <xsl:when test=". = '388'">Квадрильон руб</xsl:when>
            <!--Квадрильон рублей-->
            <xsl:when test=". = '414'">пасс.км</xsl:when>
            <!--Пассажиро-километр-->
            <xsl:when test=". = '421'">пасс. мест</xsl:when>
            <!--Пассажирское место (пассажирских мест)-->
            <xsl:when test=". = '423'">тыс. пасс.км</xsl:when>
            <!--Тысяча пассажиро-километров-->
            <xsl:when test=". = '424'">млн. пасс. км</xsl:when>
            <!--Миллион пассажиро-километров-->
            <xsl:when test=". = '427'">пасс.поток</xsl:when>
            <!--Пассажиропоток-->
            <xsl:when test=". = '449'">т.км</xsl:when>
            <!--Тонно-километр-->
            <xsl:when test=". = '450'">тыс. т.км</xsl:when>
            <!--Тысяча тонно-километров-->
            <xsl:when test=". = '451'">млн. т. км</xsl:when>
            <!--Миллион тонно-километров-->
            <xsl:when test=". = '479'">тыс. набор</xsl:when>
            <!--Тысяча наборов-->
            <xsl:when test=". = '510'">г/кВт.ч</xsl:when>
            <!--Грамм на киловатт-час-->
            <xsl:when test=". = '511'">кг/Гкал</xsl:when>
            <!--Килограмм на гигакалорию-->
            <xsl:when test=". = '512'">т.ном</xsl:when>
            <!--Тонно-номер-->
            <xsl:when test=". = '513'">авто т</xsl:when>
            <!--Автотонна-->
            <xsl:when test=". = '514'">т.тяги</xsl:when>
            <!--Тонна тяги-->
            <xsl:when test=". = '515'">дедвейт.т</xsl:when>
            <!--Дедвейт-тонна-->
            <xsl:when test=". = '516'">т.танид</xsl:when>
            <!--Тонно-танид-->
            <xsl:when test=". = '521'">чел/м<sup><small>2</small></sup></xsl:when>
            <!--Человек на квадратный метр-->
            <xsl:when test=". = '522'">чел/км<sup><small>2</small></sup></xsl:when>
            <!--Человек на квадратный километр-->
            <xsl:when test=". = '534'">т/ч</xsl:when>
            <!--Тонна в час-->
            <xsl:when test=". = '535'">т/сут</xsl:when>
            <!--Тонна в сутки-->
            <xsl:when test=". = '536'">т/смен</xsl:when>
            <!--Тонна в смену-->
            <xsl:when test=". = '537'">тыс. т/сез</xsl:when>
            <!--Тысяча тонн в сезон-->
            <xsl:when test=". = '538'">тыс. т/год</xsl:when>
            <!--Тысяча тонн в год-->
            <xsl:when test=". = '539'">чел.ч</xsl:when>
            <!--Человеко-час-->
            <xsl:when test=". = '540'">чел.дн</xsl:when>
            <!--Человеко-день-->
            <xsl:when test=". = '541'">тыс. чел.дн</xsl:when>
            <!--Тысяча человеко-дней-->
            <xsl:when test=". = '542'">тыс. чел.ч</xsl:when>
            <!--Тысяча человеко-часов-->
            <xsl:when test=". = '543'">тыс. усл. банк/ смен</xsl:when>
            <!--Тысяча условных банок в смену-->
            <xsl:when test=". = '544'">млн. ед/год</xsl:when>
            <!--Миллион единиц в год-->
            <xsl:when test=". = '545'">посещ/смен</xsl:when>
            <!--Посещение в смену-->
            <xsl:when test=". = '546'">тыс. посещ/смен</xsl:when>
            <!--Тысяча посещений в смену-->
            <xsl:when test=". = '547'">пар/смен</xsl:when>
            <!--Пара в смену-->
            <xsl:when test=". = '548'">тыс. пар/смен</xsl:when>
            <!--Тысяча пар в смену-->
            <xsl:when test=". = '550'">млн. т/год</xsl:when>
            <!--Миллион тонн в год-->
            <xsl:when test=". = '552'">т перераб/сут</xsl:when>
            <!--Тонна переработки в сутки-->
            <xsl:when test=". = '553'">тыс. т перераб/ сут</xsl:when>
            <!--Тысяча тонн переработки в сутки-->
            <xsl:when test=". = '554'">ц перераб/сут</xsl:when>
            <!--Центнер переработки в сутки-->
            <xsl:when test=". = '555'">тыс. ц перераб/ сут</xsl:when>
            <!--Тысяча центнеров переработки в сутки-->
            <xsl:when test=". = '556'">тыс. гол/год</xsl:when>
            <!--Тысяча голов в год-->
            <xsl:when test=". = '557'">млн. гол/год</xsl:when>
            <!--Миллион голов в год-->
            <xsl:when test=". = '558'">тыс. птицемест</xsl:when>
            <!--Тысяча птицемест-->
            <xsl:when test=". = '559'">тыс. кур. несуш</xsl:when>
            <!--Тысяча кур-несушек-->
            <xsl:when test=". = '2541'">бит/с</xsl:when>
            <!--Бит в секунду-->
            <xsl:when test=". = '2543'">кбит/с</xsl:when>
            <!--Килобит в секунду-->
            <xsl:when test=". = '561'">тыс. т пар/ч</xsl:when>
            <!--Тысяча тонн пара в час-->
            <xsl:when test=". = '562'">тыс. пряд.верет</xsl:when>
            <!--Тысяча прядильных веретен-->
            <xsl:when test=". = '563'">тыс. пряд.мест</xsl:when>
            <!--Тысяча прядильных мест-->
            <xsl:when test=". = '639'">доз</xsl:when>
            <!--Доза-->
            <xsl:when test=". = '640'">тыс. доз</xsl:when>
            <!--Тысяча доз-->
            <xsl:when test=". = '642'">ед</xsl:when>
            <!--Единица-->
            <xsl:when test=". = '643'">тыс. ед</xsl:when>
            <!--Тысяча единиц-->
            <xsl:when test=". = '644'">млн. ед</xsl:when>
            <!--Миллион единиц-->
            <xsl:when test=". = '661'">канал</xsl:when>
            <!--Канал-->
            <xsl:when test=". = '673'">тыс. компл</xsl:when>
            <!--Тысяча комплектов-->
            <xsl:when test=". = '698'">мест</xsl:when>
            <!--Место-->
            <xsl:when test=". = '699'">тыс. мест</xsl:when>
            <!--Тысяча мест-->
            <xsl:when test=". = '709'">тыс. ном</xsl:when>
            <!--Тысяча номеров-->
            <xsl:when test=". = '724'">тыс. га порц</xsl:when>
            <!--Тысяча гектаров порций-->
            <xsl:when test=". = '729'">тыс. пач</xsl:when>
            <!--Тысяча пачек-->
            <xsl:when test=". = '744'">%</xsl:when>
            <!--Процент-->
            <xsl:when test=". = '746'">‰</xsl:when>
            <!--Промилле (0,1 процента)-->
            <xsl:when test=". = '751'">тыс. рул</xsl:when>
            <!--Тысяча рулонов-->
            <xsl:when test=". = '761'">тыс. стан</xsl:when>
            <!--Тысяча станов-->
            <xsl:when test=". = '762'">станц</xsl:when>
            <!--Станция-->
            <xsl:when test=". = '775'">тыс. тюбик</xsl:when>
            <!--Тысяча тюбиков-->
            <xsl:when test=". = '776'">тыс. усл.туб</xsl:when>
            <!--Тысяча условных тубов-->
            <xsl:when test=". = '779'">млн. упак</xsl:when>
            <!--Миллион упаковок-->
            <xsl:when test=". = '782'">тыс. упак</xsl:when>
            <!--Тысяча упаковок-->
            <xsl:when test=". = '792'">чел</xsl:when>
            <!--Человек-->
            <xsl:when test=". = '793'">тыс. чел</xsl:when>
            <!--Тысяча человек-->
            <xsl:when test=". = '794'">млн. чел</xsl:when>
            <!--Миллион человек-->
            <xsl:when test=". = '808'">млн. экз</xsl:when>
            <!--Миллион экземпляров-->
            <xsl:when test=". = '810'">яч</xsl:when>
            <!--Ячейка-->
            <xsl:when test=". = '812'">ящ</xsl:when>
            <!--Ящик-->
            <xsl:when test=". = '836'">гол</xsl:when>
            <!--Голова-->
            <xsl:when test=". = '837'">тыс. пар</xsl:when>
            <!--Тысяча пар-->
            <xsl:when test=". = '838'">млн. пар</xsl:when>
            <!--Миллион пар-->
            <xsl:when test=". = '839'">компл</xsl:when>
            <!--Комплект-->
            <xsl:when test=". = '840'">секц</xsl:when>
            <!--Секция-->
            <xsl:when test=". = '868'">бут</xsl:when>
            <!--Бутылка-->
            <xsl:when test=". = '869'">тыс. бут</xsl:when>
            <!--Тысяча бутылок-->
            <xsl:when test=". = '870'">ампул</xsl:when>
            <!--Ампула-->
            <xsl:when test=". = '871'">тыс. ампул</xsl:when>
            <!--Тысяча ампул-->
            <xsl:when test=". = '872'">флак</xsl:when>
            <!--Флакон-->
            <xsl:when test=". = '873'">тыс. флак</xsl:when>
            <!--Тысяча флаконов-->
            <xsl:when test=". = '874'">тыс. туб</xsl:when>
            <!--Тысяча тубов-->
            <xsl:when test=". = '875'">тыс. кор</xsl:when>
            <!--Тысяча коробок-->
            <xsl:when test=". = '876'">усл. ед</xsl:when>
            <!--Условная единица-->
            <xsl:when test=". = '877'">тыс. усл. ед</xsl:when>
            <!--Тысяча условных единиц-->
            <xsl:when test=". = '878'">млн. усл. ед</xsl:when>
            <!--Миллион условных единиц-->
            <xsl:when test=". = '879'">усл. шт</xsl:when>
            <!--Условная штука-->
            <xsl:when test=". = '880'">тыс. усл. шт</xsl:when>
            <!--Тысяча условных штук-->
            <xsl:when test=". = '881'">усл. банк</xsl:when>
            <!--Условная банка-->
            <xsl:when test=". = '882'">тыс. усл. банк</xsl:when>
            <!--Тысяча условных банок-->
            <xsl:when test=". = '883'">млн. усл. банк</xsl:when>
            <!--Миллион условных банок-->
            <xsl:when test=". = '884'">усл. кус</xsl:when>
            <!--Условный кусок-->
            <xsl:when test=". = '885'">тыс. усл. кус</xsl:when>
            <!--Тысяча условных кусков-->
            <xsl:when test=". = '886'">млн. усл. кус</xsl:when>
            <!--Миллион условных кусков-->
            <xsl:when test=". = '887'">усл. ящ</xsl:when>
            <!--Условный ящик-->
            <xsl:when test=". = '888'">тыс. усл. ящ</xsl:when>
            <!--Тысяча условных ящиков-->
            <xsl:when test=". = '889'">усл. кат</xsl:when>
            <!--Условная катушка-->
            <xsl:when test=". = '890'">тыс. усл. кат</xsl:when>
            <!--Тысяча условных катушек-->
            <xsl:when test=". = '891'">усл. плит</xsl:when>
            <!--Условная плитка-->
            <xsl:when test=". = '892'">тыс. усл. плит</xsl:when>
            <!--Тысяча условных плиток-->
            <xsl:when test=". = '893'">усл. кирп</xsl:when>
            <!--Условный кирпич-->
            <xsl:when test=". = '894'">тыс. усл. кирп</xsl:when>
            <!--Тысяча условных кирпичей-->
            <xsl:when test=". = '895'">млн. усл. кирп</xsl:when>
            <!--Миллион условных кирпичей-->
            <xsl:when test=". = '896'">семей</xsl:when>
            <!--Семья-->
            <xsl:when test=". = '897'">тыс. семей</xsl:when>
            <!--Тысяча семей-->
            <xsl:when test=". = '898'">млн. семей</xsl:when>
            <!--Миллион семей-->
            <xsl:when test=". = '899'">домхоз</xsl:when>
            <!--Домохозяйство-->
            <xsl:when test=". = '900'">тыс. домхоз</xsl:when>
            <!--Тысяча домохозяйств-->
            <xsl:when test=". = '901'">млн. домхоз</xsl:when>
            <!--Миллион домохозяйств-->
            <xsl:when test=". = '902'">учен. мест</xsl:when>
            <!--Ученическое место-->
            <xsl:when test=". = '903'">тыс. учен. мест</xsl:when>
            <!--Тысяча ученических мест-->
            <xsl:when test=". = '904'">раб. мест</xsl:when>
            <!--Рабочее место-->
            <xsl:when test=". = '905'">тыс. раб. мест</xsl:when>
            <!--Тысяча рабочих мест-->
            <xsl:when test=". = '906'">посад. мест</xsl:when>
            <!--Посадочное место-->
            <xsl:when test=". = '907'">тыс. посад. мест</xsl:when>
            <!--Тысяча посадочных мест-->
            <xsl:when test=". = '908'">ном</xsl:when>
            <!--Номер-->
            <xsl:when test=". = '909'">кварт</xsl:when>
            <!--Квартира-->
            <xsl:when test=". = '910'">тыс. кварт</xsl:when>
            <!--Тысяча квартир-->
            <xsl:when test=". = '911'">коек</xsl:when>
            <!--Койка-->
            <xsl:when test=". = '912'">тыс. коек</xsl:when>
            <!--Тысяча коек-->
            <xsl:when test=". = '913'">том книжн. фонд</xsl:when>
            <!--Том книжного фонда-->
            <xsl:when test=". = '914'">тыс. том. книжн. фонд</xsl:when>
            <!--Тысяча томов книжного фонда-->
            <xsl:when test=". = '915'">усл. рем</xsl:when>
            <!--Условный ремонт-->
            <xsl:when test=". = '916'">усл. рем/год</xsl:when>
            <!--Условный ремонт в год-->
            <xsl:when test=". = '917'">смен</xsl:when>
            <!--Смена-->
            <xsl:when test=". = '918'">л. авт</xsl:when>
            <!--Лист авторский-->
            <xsl:when test=". = '920'">л. печ</xsl:when>
            <!--Лист печатный-->
            <xsl:when test=". = '921'">л. уч.-изд</xsl:when>
            <!--Лист учетно-издательский-->
            <xsl:when test=". = '922'">знак</xsl:when>
            <!--Знак-->
            <xsl:when test=". = '923'">слово</xsl:when>
            <!--Слово-->
            <xsl:when test=". = '924'">символ</xsl:when>
            <!--Символ-->
            <xsl:when test=". = '925'">усл. труб</xsl:when>
            <!--Условная труба-->
            <xsl:when test=". = '930'">тыс. пласт</xsl:when>
            <!--Тысяча пластин-->
            <xsl:when test=". = '937'">млн. доз</xsl:when>
            <!--Миллион доз-->
            <xsl:when test=". = '949'">млн. лист.оттиск</xsl:when>
            <!--Миллион листов-оттисков-->
            <xsl:when test=". = '950'">ваг (маш).дн</xsl:when>
            <!--Вагоно(машино)-день-->
            <xsl:when test=". = '951'">тыс. ваг (маш).ч</xsl:when>
            <!--Тысяча вагоно-(машино)-часов-->
            <xsl:when test=". = '952'">тыс. ваг (маш).км</xsl:when>
            <!--Тысяча вагоно-(машино)-километров-->
            <xsl:when test=". = '953'">тыс. мест.км</xsl:when>
            <!--Тысяча место-километров-->
            <xsl:when test=". = '954'">ваг.сут</xsl:when>
            <!--Вагоно-сутки-->
            <xsl:when test=". = '955'">тыс. поезд.ч</xsl:when>
            <!--Тысяча поездо-часов-->
            <xsl:when test=". = '956'">тыс. поезд.км</xsl:when>
            <!--Тысяча поездо-километров-->
            <xsl:when test=". = '957'">тыс. т.миль</xsl:when>
            <!--Тысяча тонно-миль-->
            <xsl:when test=". = '958'">тыс. пасс.миль</xsl:when>
            <!--Тысяча пассажиро-миль-->
            <xsl:when test=". = '959'">автомоб.дн</xsl:when>
            <!--Автомобиле-день-->
            <xsl:when test=". = '960'">тыс. автомоб.т.дн</xsl:when>
            <!--Тысяча автомобиле-тонно-дней-->
            <xsl:when test=". = '961'">тыс. автомоб.ч</xsl:when>
            <!--Тысяча автомобиле-часов-->
            <xsl:when test=". = '962'">тыс. автомоб.мест. дн</xsl:when>
            <!--Тысяча автомобиле-место-дней-->
            <xsl:when test=". = '963'">привед.ч</xsl:when>
            <!--Приведенный час-->
            <xsl:when test=". = '964'">самолет.км</xsl:when>
            <!--Самолето-километр-->
            <xsl:when test=". = '965'">тыс. км</xsl:when>
            <!--Тысяча километров-->
            <xsl:when test=". = '966'">тыс. тоннаж. рейс</xsl:when>
            <!--Тысяча тоннаже-рейсов-->
            <xsl:when test=". = '967'">млн. т. миль</xsl:when>
            <!--Миллион тонно-миль-->
            <xsl:when test=". = '968'">млн. пасс. миль</xsl:when>
            <!--Миллион пассажиро-миль-->
            <xsl:when test=". = '969'">млн. тоннаж. миль</xsl:when>
            <!--Миллион тоннаже-миль-->
            <xsl:when test=". = '970'">млн. пасс. мест. миль</xsl:when>
            <!--Миллион пассажиро-место-миль-->
            <xsl:when test=". = '971'">корм. дн</xsl:when>
            <!--Кормо-день-->
            <xsl:when test=". = '972'">ц корм ед</xsl:when>
            <!--Центнер кормовых единиц-->
            <xsl:when test=". = '973'">тыс. автомоб. км</xsl:when>
            <!--Тысяча автомобиле-километров-->
            <xsl:when test=". = '974'">тыс. тоннаж. сут</xsl:when>
            <!--Тысяча тоннаже-сут-->
            <xsl:when test=". = '975'">суго. сут.</xsl:when>
            <!--Суго-сутки-->
            <xsl:when test=". = '976'">штук в 20-футовом эквиваленте</xsl:when>
            <!--Штук в 20-футовом эквиваленте (ДФЭ)-->
            <xsl:when test=". = '977'">канал. км</xsl:when>
            <!--Канало-километр-->
            <xsl:when test=". = '978'">канал. конц</xsl:when>
            <!--Канало-концы-->
            <xsl:when test=". = '979'">тыс. экз</xsl:when>
            <!--Тысяча экземпляров-->
            <xsl:when test=". = '980'">тыс. доллар</xsl:when>
            <!--Тысяча долларов-->
            <xsl:when test=". = '981'">тыс. корм ед</xsl:when>
            <!--Тысяча тонн кормовых единиц-->
            <xsl:when test=". = '982'">млн. корм ед</xsl:when>
            <!--Миллион тонн кормовых единиц-->
            <xsl:when test=". = '983'">суд.сут</xsl:when>
            <!--Судо-сутки-->
            <xsl:when test=". = '2545'">Мбит/с</xsl:when>
            <!--Мегабит в секунду-->
            <xsl:when test=". = '2547'">Гбит/с</xsl:when>
            <!--Гигабит в секунду-->
            <xsl:when test=". = '2551'">Байт/с</xsl:when>
            <!--Байт в секунду-->
            <xsl:when test=". = '2552'">Гбайт/с</xsl:when>
            <!--Гигабайт в секунду-->
            <xsl:when test=". = '2561'">кбайт/с</xsl:when>
            <!--Килобайт в секунду-->
            <xsl:when test=". = '2571'">Мбайт/с</xsl:when>
            <!--Мегабайт в секунду-->
            <xsl:when test=". = '2581'">Эрл</xsl:when>
            <!--Эрланг-->
            <xsl:when test=". = '276'">Гр</xsl:when>
            <!--Грей-->
            <xsl:when test=". = '3135'">Дб</xsl:when>
            <!--Децибел-->
            <xsl:when test=". = '7923'">Абонент</xsl:when>
            <!--Абонент-->
            <xsl:when test=". = '9061'">млн. га</xsl:when>
            <!--Миллион гектаров-->
            <xsl:when test=". = '9062'">млрд. га</xsl:when>
            <!--Миллиард гектаров-->
            <xsl:when test=". = '9557'">млн. гол</xsl:when>
            <!--Миллион голов-->
            <xsl:when test=". = '9642'">балл</xsl:when>
            <!--Балл-->
            <xsl:when test=". = '9802'">млн. доллар</xsl:when>
            <!--Миллион долларов-->
            <xsl:when test=". = '984'">ц/га</xsl:when>
            <!--Центнеров с гектара-->
            <xsl:when test=". = '985'">тыс. гол</xsl:when>
            <!--Тысяча голов-->
            <xsl:when test=". = '986'">тыс. краск. оттиск</xsl:when>
            <!--Тысяча краско-оттисков -->
            <xsl:when test=". = '987'">млн. краск. оттиск</xsl:when>
            <!--Миллион краско-оттисков-->
            <xsl:when test=". = '988'">млн. усл. плит</xsl:when>
            <!--Миллион условных плиток-->
            <xsl:when test=". = '989'">чел/ч</xsl:when>
            <!--Человек в час-->
            <xsl:when test=". = '990'">пасс/ч</xsl:when>
            <!--Пассажиров в час-->
            <xsl:when test=". = '991'">пасс. миля</xsl:when>
            <!--Пассажиро-миля-->
            <xsl:when test=". = '2553'">Гбайт</xsl:when>
            <!--Гигабайт-->
            <xsl:when test=". = '2554'">Тбайт</xsl:when>
            <!--Терабайт-->
            <xsl:when test=". = '2555'">Пбайт</xsl:when>
            <!--Петабайт-->
            <xsl:when test=". = '2556'">Эбайт</xsl:when>
            <!--Эксабайт-->
            <xsl:when test=". = '2557'">Збайт</xsl:when>
            <!--Зеттабайт-->
            <xsl:when test=". = '2558'">Йбайт</xsl:when>
            <!--Йоттабайт-->
            <xsl:when test=". = '3831'">руб. тонна</xsl:when>
            <!--Рубль тонна-->
            <xsl:when test=". = '5401'">дет. дн</xsl:when>
            <!--Дето-день-->
            <xsl:when test=". = '5423'">чел/год</xsl:when>
            <!--Человек в год-->
            <xsl:when test=". = '5451'">посещ</xsl:when>
            <!--Посещение-->
            <xsl:when test=". = '5562'">тыс. гнезд</xsl:when>
            <!--Тысяча гнезд-->
            <xsl:when test=". = '6421'">ед/год</xsl:when>
            <!--Единиц в год-->
            <xsl:when test=". = '6422'">вызов</xsl:when>
            <!--Вызов-->
            <xsl:when test=". = '6424'">штамм</xsl:when>
            <!--Штамм-->
            <xsl:when test=". = '8361'">ос</xsl:when>
            <!--Особь-->
            <xsl:when test=". = '8751'">кор</xsl:when>
            <!--Коробка-->
            <xsl:when test=". = '9111'">койк. дн</xsl:when>
            <!--Койко-день-->
            <xsl:when test=". = '9113'">пациент. дн</xsl:when>
            <!--Пациенто-день-->
            <xsl:when test=". = '9245'">запись</xsl:when>
            <!--Запись-->
            <xsl:when test=". = '9246'">докум</xsl:when>
            <!--Документ-->
            <xsl:when test=". = '9491'">лист. оттиск</xsl:when>
            <!--Лист-оттиск-->
            <xsl:when test=". = '9501'">ваг (маш) ч</xsl:when>
            <!--Вагоно (машино)-час-->
            <xsl:when test=". = '9641'">летн. ч</xsl:when>
            <!--Летный час-->
            <xsl:when test=". = '9803'">млрд. доллар</xsl:when>
            <!--Миллиард долларов-->
            <xsl:when test=". = '9805'">доллар за тонну</xsl:when>
            <!--Доллар за тонну-->
            <xsl:when test=". = '6423'">пос.ед</xsl:when>
            <!--Посевная единица-->
            <xsl:when test=". = '508'">103 м<sup><small>3</small></sup>/ч</xsl:when>
            <!--Тысяча метров кубических в час-->
            <xsl:when test=". = '164'">мкг</xsl:when>
            <!--Микрограмм-->
            <xsl:when test=". = '303'">кБк</xsl:when>
            <!--Килобеккерель-->
            <xsl:when test=". = '307'">МБк</xsl:when>
            <!--Мегабеккерель-->
            <xsl:when test=". = '320'">моль</xsl:when>
            <!--Моль-->
            <xsl:when test=". = '9910'">МЕ</xsl:when>
            <!--Международная единица биологической активности-->
            <xsl:when test=". = '9911'">тыс. МЕ</xsl:when>
            <!--Тысяча международных единиц биологической активности-->
            <xsl:when test=". = '9912'">млн. МЕ</xsl:when>
            <!--Миллион международных единиц биологической активности-->
            <xsl:when test=". = '9913'">МЕ/г</xsl:when>
            <!--Международная единица биологической активности на грамм-->
            <xsl:when test=". = '9914'">тыс. МЕ/г</xsl:when>
            <!--Тысяча международных единиц биологической активности на грамм-->
            <xsl:when test=". = '9915'">млн. МЕ/г</xsl:when>
            <!--Миллион международных единиц биологической активности на грамм-->
            <xsl:when test=". = '9916'">МЕ/мл</xsl:when>
            <!--Международная единица биологической активности на миллилитр-->
            <xsl:when test=". = '9917'">тыс. МЕ/мл</xsl:when>
            <!--Тысяча международных единиц биологической активности на миллилитр-->
            <xsl:when test=". = '9918'">млн. МЕ/мл</xsl:when>
            <!--Миллион международных единиц биологической активности на миллилитр-->
            <xsl:when test=". = '9920'">ЕД</xsl:when>
            <!--Единица действия биологической активности-->
            <xsl:when test=". = '9921'">ЕД/г</xsl:when>
            <!--Единица биологической активности на грамм-->
            <xsl:when test=". = '9922'">тыс. ЕД/г</xsl:when>
            <!--Тысяча единиц действия биологической активности на грамм-->
            <xsl:when test=". = '9923'">ЕД/мкл</xsl:when>
            <!--Единица действия биологической активности на микролитр-->
            <xsl:when test=". = '9924'">ЕД/мл</xsl:when>
            <!--Единица действия биологической активности на миллилитр-->
            <xsl:when test=". = '9925'">тыс. ЕД/мл</xsl:when>
            <!--Тысяча единиц действия биологической активности на миллилитр-->
            <xsl:when test=". = '9926'">млн. ЕД/мл</xsl:when>
            <!--Миллион единиц действия биологической активности на миллилитр-->
            <xsl:when test=". = '9927'">ЕД/сут</xsl:when>
            <!--Единица действия биологической активности в сутки-->
            <xsl:when test=". = '9930'">АЕ</xsl:when>
            <!--Антитоксическая единица-->
            <xsl:when test=". = '9931'">тыс. АЕ</xsl:when>
            <!--Тысяча антитоксических единиц-->
            <xsl:when test=". = '9940'">АТрЕ</xsl:when>
            <!--Антитрипсиновая единица-->
            <xsl:when test=". = '9941'">тыс. АТрЕ</xsl:when>
            <!--Тысяча антитрипсиновых единиц-->
            <xsl:when test=". = '9950'">ИР</xsl:when>
            <!--Индекс Реактивности-->
            <xsl:when test=". = '9951'">ИР/мл</xsl:when>
            <!--Индекс Реактивности на миллилитр-->
            <xsl:when test=". = '9960'">кБк/мл</xsl:when>
            <!--Килобеккерель на миллилитр-->
            <xsl:when test=". = '9961'">МБк/мл</xsl:when>
            <!--Мегабеккерель на миллилитр-->
            <xsl:when test=". = '9962'">МБк/м<sup><small>2</small></sup></xsl:when>
            <!--Мегабеккерель на метр квадратный-->
            <xsl:when test=". = '9970'">КИЕ/мл</xsl:when>
            <!--Калликреиновая ингибирующая единица на миллилитр-->
            <xsl:when test=". = '9971'">тыс. КИЕ/МЛ</xsl:when>
            <!--Тысяча калликреиновых ингибирующих единиц на миллилитр-->
            <xsl:when test=". = '9980'">млн. КОЕ</xsl:when>
            <!--Миллион колониеобразующих единиц-->
            <xsl:when test=". = '9981'">млн. КОЕ/пакет</xsl:when>
            <!--Миллион колониеобразующих единиц на пакет-->
            <xsl:when test=". = '9982'">млрд. КОЕ</xsl:when>
            <!--Миллиард колониеобразующих единиц-->
            <xsl:when test=". = '9983'">ПЕ</xsl:when>
            <!--Протеолитическая единица-->
            <xsl:when test=". = '9985'">Мкг/мл</xsl:when>
            <!--Микрограмм на миллилитр-->
            <xsl:when test=". = '9986'">Мкг/сут</xsl:when>
            <!--Микрограмм в сутки-->
            <xsl:when test=". = '9987'">Мкг/ч</xsl:when>
            <!--Микрограмм в час-->
            <xsl:when test=". = '9988'">Мкг/доза</xsl:when>
            <!--Микрограмм на дозу-->
            <xsl:when test=". = '9990'">моль/мл</xsl:when>
            <!--Миллимоль на миллилитр-->
            <xsl:when test=". = '9991'">ммоль/л</xsl:when>
            <!--Миллимоль на литр-->
            <xsl:when test=". = '728'">пач</xsl:when>
            <!--Пачка-->
            <xsl:when test=". = '509'">км/сут</xsl:when>
            <!--Километр в сутки-->
            <xsl:when test=". = '277'">мкГр</xsl:when>
            <!--Микрогрей-->
            <xsl:when test=". = '278'">мГр</xsl:when>
            <!--Миллигрей-->
            <xsl:when test=". = '279'">кГр</xsl:when>
            <!--Килогрей-->
            <xsl:when test=". = '293'">ГГц</xsl:when>
            <!--Гигагерц-->
            <xsl:when test=". = '295'">ТГц</xsl:when>
            <!--Терагерц-->
            <xsl:when test=". = '351'">нс</xsl:when>
            <!--Наносекунда-->
            <xsl:when test=". = '318'">Зв</xsl:when>
            <!--Зиверт-->
            <xsl:when test=". = '319'">мкЗв</xsl:when>
            <!--Микрозиверт-->
            <xsl:when test=". = '321'">мЗв</xsl:when>
            <!--Миллизиверт-->
            <xsl:when test=". = '348'">фс</xsl:when>
            <!--Фемтосекунда-->
            <xsl:when test=". = '350'">пс</xsl:when>
            <!--Пикосекунда-->
            <xsl:when test=". = '2311'">Гр/с</xsl:when>
            <!--Грей в секунду-->
            <xsl:when test=". = '2312'">Гр/мин</xsl:when>
            <!--Грей в минуту-->
            <xsl:when test=". = '2313'">Гр/ч</xsl:when>
            <!--Грей в час-->
            <xsl:when test=". = '2314'">мкГр/с</xsl:when>
            <!--Микрогрей в секунду-->
            <xsl:when test=". = '2315'">мкГр/ч</xsl:when>
            <!--Микрогрей в час-->
            <xsl:when test=". = '2316'">мГр/ч</xsl:when>
            <!--Миллигрей в час-->
            <xsl:when test=". = '2351'">Зв/ч</xsl:when>
            <!--Зиверт в час-->
            <xsl:when test=". = '2352'">мкЗв/с</xsl:when>
            <!--Микрозиверт в секунду-->
            <xsl:when test=". = '2353'">мкЗв/ч</xsl:when>
            <!--Микрозиверт в час-->
            <xsl:when test=". = '2354'">мЗв/ч</xsl:when>
            <!--Миллизиверт в час-->
            <xsl:when test=". = '426'">пар груз поезд/сут</xsl:when>
            <!--Пар грузовых поездов в сутки-->
            <xsl:when test=". = '747'">б.п.</xsl:when>
            <!--Базисный пункт-->
            <xsl:when test=". = '340'">г у.т./кВт•ч</xsl:when>
            <!--Грамм условного топлива на киловатт-час-->
            <xsl:when test=". = '341'">кг у.т./Гкал</xsl:when>
            <!--Килограмм условного топлива на гигакалорию-->
            <xsl:when test=". = '9823'">млрд. евро</xsl:when>
            <!--Миллиард евро-->
            <xsl:when test=". = '9822'">млн. евро</xsl:when>
            <!--Миллион евро-->
            <xsl:when test=". = '3181'">чел.-Зв</xsl:when>
            <!--Человеко-зиверт-->
            <xsl:when test=". = '3231'">Бк/м<sup><small>3</small></sup></xsl:when>
            <!--Беккерель на метр кубический-->
        </xsl:choose>
    </xsl:template>
    ...
    <xsl:template name="PrintDangerousAndComplexObject">
        <xsl:param name="Code" select="0"/>
        <p>Объект относится к категории особо опасных и технически сложных объектов в соответствии с пунктом <xsl:choose>
            ...
            </xsl:choose> части 1 статьи 48.1 Градостроительного кодекса Российской Федерации:</p>
        <p>
            <xsl:choose>
                <xsl:when test="$Code = 1">1) объекты использования атомной энергии в соответствии с законодательством Российской Федерации об использовании атомной энергии, за исключением объектов, содержащих:<br/> а) только радиационные источники, в которых генерируется ионизирующее излучение, на объектах, радиационное воздействие от которых в случае аварии ограничивается помещениями, где осуществляется непосредственное обращение с источниками ионизирующего излучения;<br/> б) радиационные источники, содержащие в своем составе только радионуклидные источники четвертой и пятой категорий радиационной опасности в соответствии с законодательством Российской Федерации об использовании атомной энергии </xsl:when>
